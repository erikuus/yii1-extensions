...
$this->breadcrumbs=array(
	...
	Yii::t($this->module->messageCategory,XHtml::labelize($model->type))=>array('admin','type'=>$model->type),
...
<?php echo Yii::t('LookupModule.ui', 'Update'); ?>
 &#171;<?php echo Yii::t($this->module->messageCategory, XHtml::labelize($model->type)); ?>&#187;
</h2>
