<?php
/**
 * XJsTree displays a tree view of hierarchical data.
 *
...
class XJsTree extends CWidget
{
	...
	public function init()
	{
		...
		//$cs->registerScript('Yii.XJsTree#'.$id,"$(function () { $(\"#{$id}\").tree($options); });");
		$cs->registerScript('Yii.XJsTree#'.$id,"$(\"#{$id}\").jstree($options);");
