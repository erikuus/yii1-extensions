<?php
/**
 * XVau2Bookmark class file
 *
 * Widget to implement a VAU Bookmark service
 *
 * Example of usage:
 * <pre>
 *     $this->widget('ext.widgets.vau.XVau2Bookmark', array(
 ...
 * @version 2.0.0
 */
class XVau2Bookmark extends CWidget
{
	private $_cssClass='vau2Bookmark';
	private $_vauUrl='http://localhost/labs/kliendimoodul/index-dev.php';
