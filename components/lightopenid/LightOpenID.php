...
/**
 * Replaced: $this->trustRoot = (!empty($_SERVER['HTTPS']) ||  ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
 * with: $this->trustRoot = Yii::app()->getRequest()->getHostInfo()
 *
 * Note that when using ISAPI with IIS, the $_SERVER['HTTPS'] value will be 'off'
...
class LightOpenID
{
    ...
    {
        $this->trustRoot = Yii::app()->getRequest()->getHostInfo();
