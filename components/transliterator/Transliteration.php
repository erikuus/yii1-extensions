...
class Transliteration extends CApplicationComponent
{
	 ...
	 * @param boolean $removeAccents whether to remove accents.
	 * @return string the transliterated content
	 */
	public function transliterate($content, $removeAccents=false)
	{
		$content=str_replace(array_keys($this->transliterationTable), array_values($this->transliterationTable), $content);
