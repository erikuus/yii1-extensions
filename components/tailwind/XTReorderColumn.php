...
class XTReorderColumn extends CGridColumn
{
	 ...
	 */
	public $upIcon='<svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4 12L5.41 13.41L11 7.83V20H13V7.83L18.58 13.42L20 12L12 4L4 12Z" fill="currentColor"></path></svg>';
	/**
	 * @var string the down icon.
	 */
	public $downIcon='<svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M20 12L18.59 10.59L13 16.17V4H11V16.17L5.42 10.58L4 12L12 20L20 12Z" fill="currentColor"></path></svg>';
	/**
	 * @var array the HTML options for the data cell tags.
	 * Defaults to array('class'=>'button-column')
	 */
	public $htmlOptions=array('class'=>'whitespace-nowrap');
	/**
